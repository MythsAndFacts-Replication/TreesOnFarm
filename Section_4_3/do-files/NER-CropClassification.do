*--- Crop Classification - Initial 
	...
	replace crop_type="NA" if crop_id==9
	...
	replace crop_type="NA" if crop_id==31
	...
	replace crop_type="Tree" if crop_id==19
	...
	replace crop_type="Small trees or shrubs" if crop_id==24
	replace crop_type="Plant/Herb/Grass/Roots" if crop_id==13
	replace crop_type="Plant/Herb/Grass/Roots" if crop_id==37
	replace crop_type="Tree" if crop_id==61
	replace crop_type="Tree" if crop_id==60

*--- Tree Classification - Initial 
gen tree_type=""

replace tree_type="Tree Crops" if crop_id==70
replace tree_type="Tree Crops" if crop_id==19
replace tree_type="Fruit Tree" if crop_id==68
replace tree_type="Fruit Tree" if crop_id==53
replace tree_type="Fruit Tree" if crop_id==51
replace tree_type="Fruit Tree" if crop_id==55
replace tree_type="Fruit Tree" if crop_id==57
replace tree_type="Fruit Tree" if crop_id==58
replace tree_type="Fruit Tree" if crop_id==56
replace tree_type="Fruit Tree" if crop_id==61
...
replace tree_type="NA" if crop_id==7
replace tree_type="Plant/Herb/Grass/Roots" if crop_id==9
replace tree_type="Plant/Herb/Grass/Roots" if crop_id==10
...
replace tree_type="NA" if crop_id==27
...
replace tree_type="Fruit Tree" if crop_id==3
replace tree_type="Plant/Herb/Grass/Roots" if crop_id==59
replace tree_type="NA" if crop_id==33
replace tree_type="Plant/Herb/Grass/Roots" if crop_id==48
replace tree_type="Plant/Herb/Grass/Roots" if crop_id==66
...
replace tree_type="Plant/Herb/Grass/Roots" if crop_id==54
replace tree_type="Plant/Herb/Grass/Roots" if crop_id==16
replace tree_type="Tree Crops" if crop_id==63
replace tree_type="Plant/Herb/Grass/Roots" if crop_id==69
replace tree_type="Plant/Herb/Grass/Roots" if crop_id==18
replace tree_type="Plant/Herb/Grass/Roots" if crop_id==36
replace tree_type="Plant/Herb/Grass/Roots" if crop_id==64
...
replace tree_type="Tree Crops" if crop_id==28
replace tree_type="Plant/Herb/Grass/Roots" if crop_id==17
replace tree_type="Plant/Herb/Grass/Roots" if crop_id==24
replace tree_type="Tree Crops" if crop_id==13
replace tree_type="Tree Crops" if crop_id==37
