...
*--- Open the Data
	...
	use "$path_work/TZN/1_Production_Clas.dta", clear

*--- Merge Data

	* HH Data
	merge n:1 y2_hhid using  "$path_work/TZN/1_HH_Information.dta", nogenerate 
...
graph export "$graphs/sec43_TZN_fig_4.png", replace width(4147) height(2250) 
...
graph export "$graphs/sec43_TZN_fig_5.png", replace width(4147) height(2250)
