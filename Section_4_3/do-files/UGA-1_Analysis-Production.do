...
*--- Open the Data
	...
	use "$path_work/UGA/1_Production_Clas.dta", clear
...
graph export "$graphs/sec43_UGA_fig_4.png", replace width(4147) height(2250) 
...
graph export "$graphs/sec43_UGA_fig_5.png", replace width(4147) height(2250)
